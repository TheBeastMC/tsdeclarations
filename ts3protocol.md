...
### 1.9.2 Generations
Packet Ids are stored as u16, this means that they range from 0-65535.
...
The generation id counter is not only important for encryption,
but also for correct decryption (see 1.6.2).
